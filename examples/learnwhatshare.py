...
from neuronlp2.models import LearnWhatShareNetwork
...
def main():
    ...
    if config.rnn.dropout == 'std':
        network = LearnWhatShareNetwork(len(data_trains), embedd_dim, word_alphabet.size(),
                                     ...
                                     char_level_rnn=config.rnn.char_level_rnn, hidden_size_private=config.rnn.hidden_size_private)
    else:
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        network.eval()
        # print(list(network.aux_to_main.named_parameters()))
        for task_id in range(len(num_batches)):
            if task_id > 0:
                print("================================================================================")
                print("dataset: %s (Ignore)" % data_names[task_id])
                print("================================================================================\n")
                continue
