...
class CoNLLXReader(object):
    ...
    def getNext(self, normalize_digits=True, symbolic_root=False, symbolic_end=False):
        ...
        for tokens in lines:
            ...
            types.append(type_)
            type_ids.append(self.__type_alphabet.get_index(type_))
...
class BioNLPReader(object):
    ...
    def getNext(self, normalize_digits=True):
        ...
        for tokens in lines:
            ...
            postags.append("O")
            pos_ids.append(self.__pos_alphabet.get_index("O"))

            chunk_tags.append("O")
            chunk_ids.append(self.__chunk_alphabet.get_index("O"))
